CREATE
  ...
  (cu2:Customer {id: 2, name: 'Customer 2'})-[:HAS_LOCATION]->(l1),
  (cu3:Customer {id: 3, name: 'Customer 3'})-[:HAS_LOCATION]->(l2),
  (cu4:Customer {id: 4, name: 'Customer 4'})-[:HAS_LOCATION]->(l2),
  (cu5:Customer {id: 5, name: 'Customer 5'})-[:HAS_LOCATION]->(l3),
